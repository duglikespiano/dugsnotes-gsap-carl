...
// saveStyles stores initial styles of selected DOM
// if the styles are not stored before ScrollTriggers are created, the styles will be broken by resizing the viewport from the breakpoint and the other breakpoint
